...
asm volatile (   
   ...
   "in r19,%1 \n\t"                 // Sample Port D  (A9.A13.A8.A14.A15.x.x.x)

   "ld r20,X+ \n\t"                 // R20 = Keymap[0] 
   "sbrs R19,5 \n\t"                // Bit [5] = 0 ? ->A8  
   "and r18,r20 \n\t"               // yes, copy active bits from Keymap[0] to R18
 
   "ld r20,X+ \n\t"                 // R20 = Keymap[1] 
   "sbrs R19,7 \n\t"                // Bit [7] = 0 ? ->A9  
   "and r18,r20 \n\t"               // yes, copy active bits from Keymap[1] to R18

   "in r19,%0 \n\t"                 // Sample Port B  (x.x.x.x.A11.A10.A12)

   "ld r20,X+ \n\t"                 // R20 = Keymap[2] 
   "sbrs R19,1 \n\t"                // Bit [1] = 0 ? ->A10 
   "and r18,r20 \n\t"               // yes, copy active bits from Keymap[2] to R18

   "ld r20,X+ \n\t"                 // R20 = Keymap[3] 
   "sbrs R19,2 \n\t"                // Bit [2] = 0 ? ->A11 
   "and r18,r20 \n\t"               // yes, copy active bits from Keymap[3] to R18

   "ld r20,X+ \n\t"                 // R20 = Keymap[4] 
   "sbrs R19,0 \n\t"                // Bit [0] = 0 ? ->A12 
   "and r18,r20 \n\t"               // yes, copy active bits from Keymap[4] to R18

   "in r19,%1 \n\t"                 // Sample Port D  (A9.A13.A8.A14.A15.x.x.x)

   "ld r20,X+ \n\t"                 // R20 = Keymap[5] 
   "sbrs R19,6 \n\t"                // Bit [6] = 0 ? ->A13 
   "and r18,r20 \n\t"               // yes, copy active bits from Keymap[5] to R18

   "ld r20,X+ \n\t"                 // R20 = Keymap[6] 
   "sbrs R19,4 \n\t"                // Bit [4] = 0 ? ->A14 
   "and r18,r20 \n\t"               // yes, copy active bits from Keymap[6] to R18

   "ld r20,X+ \n\t"                 // R20 = Keymap[7] 
   "sbrs R19,3 \n\t"                // Bit [3] = 0 ? ->A15 
   "and r18,r20 \n\t"               // yes, copy active bits from Keymap[7] to R18
