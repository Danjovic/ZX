...
_NONE,         // 0x00   
_SHIFT + _9,   // 0x01  F9   (GRAPHICS)
_NONE,         // 0x02  
_NONE,         // 0x03  F5
_NONE,         // 0x04  F3
_SHIFT + _1,   // 0x05  F1   (EDIT)
_NONE,         // 0x06  F2
_NONE,         // 0x07  F12           
_NONE,         // 0x08                
_NONE,         // 0x09  F10           
...
_NONE,         // 0x0C  F4            
_NONE,         // 0x0D  TAB           
_SHIFT + _P,   // 0x0E  APOSTROPHE    '  (ASPAS)
_NONE,         // 0x0F                
_NONE,         // 0x10                
_NONE,         // 0x11  L ALT         
_SH,           // 0x12  L SHFT        
...
_NONE,         // 0x48                
_DOT,          // 0x49  DOT           .
_SHIFT + _X,   // 0x4A  SEMICOLON     ;
_L   ,         // 0x4B  L             
_NONE,         // 0x4C  CCCEDIL       Ç
_P,            // 0x4D  P             
_SHIFT + _J,   // 0x4E  MINUS         -
_NONE,         // 0x4F  
_NONE,         // 0x50  
_SHIFT + _V,   // 0x51  SLASH         /
_NONE,         // 0x52  TILDE         ~
_NONE,         // 0x53  
_NONE,         // 0x54  ACUTE         `
_SHIFT + _L,   // 0x55  EQUAL         =
_NONE,         // 0x56  
_NONE,         // 0x57  
_NONE,         // 0x58  CAPS
_SH,           // 0x59  R SHFT
...
_NONE,         // 0x77  NUM
_NONE,         // 0x78  F11
_SHIFT + _K,   // 0x79  KPPLUS        +
_3,            // 0x7A  KP3
_SHIFT + _J,   // 0x7B  KPMINUS       -
_SHIFT + _B,   // 0x7C  KPTIMES       *
_9,            // 0x7D  KP9
_NONE,         // 0x7E  SCROLL
...
_NONE,         // 0x70  INSERT                        
_NONE,         // 0x71  DELETE                       
_SHIFT | _6,    // 0x72  DOWN Arrow                      
_NONE,         // 0x73                       
_SHIFT | _8,   // 0x74  RIGHT Arrow                     
_SHIFT | _7,   // 0x75  UP Arrow                      
_NONE,         // 0x76                        
_NONE,         // 0x77                           
_NONE,         // 0x78                        
_NONE,         // 0x79                       
